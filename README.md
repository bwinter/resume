...
* Redesigned and rebuilt rigid billing system, enabling dozens of new pricing models by generalizing it into one that was able to bill on arbitrary Ruby objects/usage.

| Senior Software Engineer, Entelo | *in-office, Mar 2017 — Jun 2017* |
| :---- | ----: |

* Built a GitHub API-based worker for data pipeline — improving data freshness/coverage for **hundreds of millions** of candidate profiles using TDD and Ruby.
...
**Observability**: Wavefront, Datadog, New Relic, PagerDuty, Elasticsearch, Fluent Bit, Metabase, Honeybadger; dashboards-as-code, performance profiling
